...
function AppRoutes() {
  ...
  if (path.startsWith('/dhenu/support')) return <DhenuSupport />;
  if (path === '/dhenu' || path === '/dhenu/') return <Dhenu />;
