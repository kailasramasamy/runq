...
export function Modal({ open, onClose, title, children, wide }: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto p-2 pt-[4vh] sm:p-4 sm:pt-[8vh]" role="dialog" aria-modal="true">
      ...
      <div className={`relative flex w-full max-h-[90vh] flex-col ${wide ? 'max-w-3xl' : 'max-w-2xl'} rounded-lg border border-zinc-200 bg-white shadow-xl dark:border-zinc-700 dark:bg-zinc-900`}>
