...
import {
  Boxes, RefreshCw, PackageX, AlertTriangle, CalendarClock, Snowflake,
} from 'lucide-react';
...
import {
  ...
  useInventoryForecast, useInventoryTrend,
  ...
  return (
    <div>
      ...
      <div className="mt-3 flex flex-col gap-3">
        ...
        {risk && <RiskSection risk={risk} index={11} />}
        {forecast && <ForecastSections forecast={forecast} index={13} />}
      </div>
    ...
    <div className="grid grid-cols-2 gap-3 md:grid-cols-3 xl:grid-cols-6">
      ...
      <StatTile
        ...
        sub={shortRun
          ...
          : health?.daysOnHand
            ? `${Math.round(health.daysOnHand)} days on hand`
            : 'per year'}
