    ...
    <div>
      ...
      <div className="space-y-2 md:hidden">
        {isLoading ? (
          ...
          <p className="py-8 text-center text-sm text-zinc-500">No tasks assigned yet.</p>
        ) : (
          tasks.map((t) => (
            <div key={t.id} className="rounded-lg border border-zinc-200 bg-white p-3 dark:border-zinc-700 dark:bg-zinc-900">
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  <p className="truncate font-medium text-zinc-900 dark:text-zinc-100">{t.title}</p>
