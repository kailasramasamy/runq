...
class HrRepo {
  ...
  Future<HrLeaveType> createLeaveType({
    ...
    final res = await apiClient.post('/hr/leave-types', {
      ...
      if (accrualMode != null) 'accrualMode': accrualMode,
      if (maxBalance != null) 'maxBalance': maxBalance,
      if (maxPaidDaysPerMonth != null) 'maxPaidDaysPerMonth': maxPaidDaysPerMonth,
      if (overflowUnpaid != null) 'overflowUnpaid': overflowUnpaid,
  ...
  Future<HrLeaveType> updateLeaveType(String id, {
    ...
    double? maxCarryForward,
    String? accrualMode,
    // Nullable-clearing isn't expressible with `if (x != null)`, so these send
    // an explicit null when [clearCaps] is set — that's how a cap is removed.
    double? maxBalance,
    double? maxPaidDaysPerMonth,
    bool clearCaps = false,
    bool? overflowUnpaid,
    bool? encashable,
    bool? isPaid,
    bool? isActive,
    ...
    final body = <String, dynamic>{
      ...
      if (maxCarryForward != null) 'maxCarryForward': maxCarryForward,
      if (accrualMode != null) 'accrualMode': accrualMode,
      if (maxBalance != null || clearCaps) 'maxBalance': maxBalance,
      if (maxPaidDaysPerMonth != null || clearCaps) 'maxPaidDaysPerMonth': maxPaidDaysPerMonth,
      if (overflowUnpaid != null) 'overflowUnpaid': overflowUnpaid,
