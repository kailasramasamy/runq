  ...
  return (
    ...
    >
      ...
      <div className={`border-t border-soft ${collapsed ? "p-2 flex flex-col items-center gap-1" : "px-3 py-2 flex items-center gap-1"}`}>
        <button onClick={() => onNavigate && onNavigate("help")} className={`${collapsed ? "h-8 w-8" : "h-7 px-2 flex-1 justify-start gap-2"} rounded-md ${active === "help" ? "accent-text surface-2" : "text-3 hover:text-1 hover:surface-2"} flex items-center text-[12px]`} title="Help & docs">
