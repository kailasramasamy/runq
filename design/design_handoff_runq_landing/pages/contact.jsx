window.audiencePageData = {
  ...
  features: [
    { Ic: I.Sparkle, title: 'Sales',          body: 'sales@runq.in · For demos, pricing for >20 users, and multi-entity setups. Average reply: 2 hours.' },
    { Ic: I.Bell, title: 'Support',           body: 'support@runq.in · For product issues, billing, and migration help. In-app chat is fastest.' },
    { Ic: I.Users, title: 'CA partnerships',  body: 'ca@runq.in · For practitioners managing 10+ client books. We have a dedicated CA program.' },
    { Ic: I.FileText, title: 'Press',         body: 'press@runq.in · For journalists and analysts. Press kit on request.' },
    { Ic: I.GitBranch, title: 'Engineering',  body: 'eng@runq.in · For API access, integration partners, and security disclosures.' },
    { Ic: I.Building, title: 'Office',        body: 'Indiranagar, Bengaluru. Walk-ins by appointment only — book a time first.' },
  ],
  darkPanel: {
