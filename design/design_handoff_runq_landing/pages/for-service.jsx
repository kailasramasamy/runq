window.audiencePageData = {
  ...
  subtitle: 'Recurring invoicing, retainer tracking, professional-fee TDS handling, and GST on services done correctly — including reverse charge for foreign clients.',
  accent: 'violet',
  lead: [
  ...
  features: [
    { Ic: I.Refresh, title: 'Recurring invoices', body: 'Monthly retainers, AMCs, subscriptions. Set once, runQ raises and reconciles every cycle.' },
    { Ic: I.Coins, title: 'Multi-currency', body: 'Bill in USD, EUR, GBP. Forex gain/loss booked at receipt. Bank-rate or RBI reference rate.' },
    { Ic: I.FileText, title: 'TDS on receipts', body: 'Customer deducts TDS? runQ matches Form 26AS, books the deduction, claims the credit.' },
    { Ic: I.Globe, title: 'Export of services', body: 'LUT-based zero-rated invoices, or with-payment refund flow. FIRC tracking included.' },
    { Ic: I.Clock, title: 'Time & milestone billing', body: 'Convert tracked hours or signed-off milestones into invoices in one click.' },
    { Ic: I.Users, title: 'Client portal', body: 'Read-only client portal: invoices, statements, payment history. White-labelled with your brand.' },
  ],
  darkPanel: {
